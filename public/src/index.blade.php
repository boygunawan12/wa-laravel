...
<head>
  ...
  <link rel="stylesheet" href="{{ url('/modules/jqvmap/dist/jqvmap.min.css') }}">
  <link rel="stylesheet" href="{{ url('/modules/summernote/summernote-bs4.css') }}">
  <link rel="stylesheet" href="{{ url('/modules/owlcarousel2/dist//owl.carousel.min.css') }}">
  <link rel="stylesheet" href="{{ url('/modules/owlcarousel2/dist//owl.theme.default.min.css') }}">
...
<button type="button" class="btn btn-primary save-btn">Save</button>
  ...
  <!-- JS Libraies -->
  <script src="{{ url('/modules/jquery.sparkline.min.js') }}"></script>
  <script src="{{ url('/modules/chart.min.js') }}"></script>
  <script src="{{ url('/modules/owlcarousel2/dist/owl.carousel.min.js') }}"></script>
  <script src="{{ url('/modules/summernote/summernote-bs4.js') }}"></script>
  <script src="{{ url('/modules/chocolat/dist/js/jquery.chocolat.min.js') }}"></script>
  ...
  <script type="text/javascript" src="{{ url('src/crudify.min.js')}}"></script>
